...
const DatePicker = ({ label, required, id, onChange, hasError }) => {
    ...
    return (
        <div className={`form-datepicker-wrapper`}>
            ...
            <div className="input-wrapper">
                <input type="text" name={id} id={id} className={hasError ? "error" : ""} readOnly onClick={() => setIsCalendarOpened(!isCalendarOpened)} value={selectedDate != "" ? selectedDate.toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' }) : ""} />
